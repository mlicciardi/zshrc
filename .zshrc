...
alias ystart-qa-discover-digital='yarn start-qa-discover-digital'
alias ystart-qa-discover-premium='yarn start-qa-discover-premium'
...
alias ystart-qa-sjp='yarn start-qa-sjp'
alias ystart-qa-stgeorge='yarn start-qa-stgeorge'
alias ystart-qa-swisscard-platinum='yarn start-qa-swisscard-platinum'
alias ystart-qa-ten='yarn start-qa-ten'
alias ystart-qa-visa-cemea='yarn start-qa-visa-cemea'
...
alias ystart-staging-discover-digital='yarn start-staging-discover-digital'
alias ystart-staging-discover-premium='yarn start-staging-discover-premium'
...
alias ystart-staging-sjp='yarn start-staging-sjp'
alias ystart-staging-stgeorge='yarn start-staging-stgeorge'
...
alias ystart-staging-visa-cemea='yarn start-staging-visa-cemea'
